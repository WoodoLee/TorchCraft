...
namespace microbattles
{
  ...
  struct MicroFeaturizer {
    ...
    std::vector<torch::Tensor> featurize(cherrypi::State* state);
  };
   ...
   **/
  struct MicroModel : public virtual ag::ContainerImpl {
    struct MicroAction {
      enum Action { Attack, Move, None } action;
      cherrypi::Unit* unit;
